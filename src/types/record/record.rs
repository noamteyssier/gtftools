...
mod testing {
    ...
    fn test_serialize() {
        ...
        assert_eq!(
            serialized,
            "{\"seqname\":\"1\",\"source\":\"ensembl_havana\",\"feature\":\"gene\",\"start\":1471765,\"end\":1497848,\"score\":\".\",\"strand\":\"+\",\"frame\":\".\",\"gene_id\":\"ENSG00000160072\",\"gene_name\":\"ATAD3B\",\"gene_source\":\"ensembl_havana\",\"gene_version\":20}"
        )
    }
}
